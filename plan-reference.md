# Plan reference — design docs & investigation history

Supporting material for `plan.md`: the full unit invariant, the 2026-09-13/14
state-lease investigation history, and the design studies. Read for context;
the working plan is plan.md.
